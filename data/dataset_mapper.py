...
class DetrDatasetMapper:
    ...
    def __init__(self, cfg, is_train=True):
        ...
        if 'VISUAL GENOME' in self.data_type:
        ...
        elif self.data_type == 'VRD':
            self.filter_duplicate_relations = cfg.DATASETS.VRD.FILTER_DUPLICATE_RELATIONS
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            if rel_present and self.data_type != "VRD":
                # Add object attributes
                instances.gt_attributes = torch.tensor(np.array([obj['attribute'] for obj in annos]), dtype=torch.int64)
