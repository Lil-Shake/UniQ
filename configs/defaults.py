...
def add_dataset_config(cfg):
  ...
  _C.DATASETS.VISUAL_GENOME.TRI_LEVEL = False
  ...
  # VRD Config
  _C.DATASETS.VRD = CN()
  _C.DATASETS.VRD.IMAGES = ''
  _C.DATASETS.VRD.IMAGE_DATA = ''
  _C.DATASETS.VRD.MAPPING_DICTIONARY = ''
  _C.DATASETS.VRD.VRD_H5 = ''
  _C.DATASETS.VRD.NUMBER_OF_VALIDATION_IMAGES = 400
  _C.DATASETS.VRD.BOX_SCALE = 1024
  _C.DATASETS.VRD.FILTER_EMPTY_RELATIONS = True
  _C.DATASETS.VRD.FILTER_NON_OVERLAP = True  
  _C.DATASETS.VRD.FILTER_DUPLICATE_RELATIONS = True
